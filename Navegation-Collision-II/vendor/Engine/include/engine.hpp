...
public:
  ...
  Type_t getType(Objects::ObjectUUID::UUID id);
  ...
  inline static const Type_t INVALID_TYPE = std::numeric_limits<Type_t>::max();
  inline static const Objects::ObjectUUID::UUID NONE_UUID = 0;
